...
namespace ClinicManagmentAPI.Migrations
{
    ...
    [Migration("20240510010914_Inital")]
            ...
            modelBuilder.Entity("ClinicManagmentAPI.Models.Enitites.MedicalReportLaborityTest", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 10, 4, 9, 14, 126, DateTimeKind.Local).AddTicks(7558));
            ...
            modelBuilder.Entity("ClinicManagmentAPI.Models.Enitites.Medicien", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 10, 4, 9, 14, 126, DateTimeKind.Local).AddTicks(8898));
            ...
            modelBuilder.Entity("ClinicManagmentAPI.Models.Enitites.MedicienList", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 10, 4, 9, 14, 127, DateTimeKind.Local).AddTicks(575));
