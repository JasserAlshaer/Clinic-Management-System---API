...
namespace ClinicManagementAPI.Controller
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public EmployeeController(IMedicalProcedureService medicalProcedureService, IMedicalReportService medicalReportService)
        {
